...
setup(
    ...
    author_email='contact@luojianet.cn',
    url='https://www.luojianet.cn/',
    download_url='https://gitee.com/luojianet/akg/tags',
    project_urls={
        'Sources': 'https://gitee.com/luojianet/akg',
        'Issue Tracker': 'https://gitee.com/luojianet/akg/issues',
    },
