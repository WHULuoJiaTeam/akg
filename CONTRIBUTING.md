...
For individual contributor, please refer to [ICLA online document](https://www.luojianet.cn/icla) for the detailed information.

## Getting Started

- Fork the repository on [Github](https://github.com/luojianet-ai/akg) or [Gitee](https://gitee.com/luojianet/akg).
...
* Clone the remote repository
    ...
    git remote add upstream https://github.com/luojianet-ai/akg.git
    # For Gitee
    git clone https://gitee.com/{insert_your_forked_repo}/akg.git
    git remote add upstream https://gitee.com/luojianet/akg.git
    ```
...
* Raise your idea as an *issue* on [GitHub](https://github.com/luojianet-ai/akg/issues) or [Gitee](https://gitee.com/luojianet/akg/issues)
